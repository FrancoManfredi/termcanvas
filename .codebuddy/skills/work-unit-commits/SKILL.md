...
| Workload guard | If the planned change exceeds ~400 lines, group commits into chained PR slices before implementation. |
...
## Verification In Each Unit

Each work unit should map cleanly to a commit or PR with:
