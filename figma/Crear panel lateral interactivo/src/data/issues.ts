export type IssueStatus = "pending" | "in-progress" | "awaiting" | "done";

export type InProgressPhase = "implementing" | "reviewing" | "fixing";

export type AwaitingAction = "review-ready" | "changes-requested" | "merge-ready";
