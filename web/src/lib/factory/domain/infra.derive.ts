...
export const CREDENTIAL_BOUNDARIES = [
  ...
  },
  {
    ...
    para: "Third-party harnesses (Claude Code, Codex)",
    boundary:
      "Config separada de la allowlist de secrets. En dashboard: campo Auth; en definitions: harness.auth: { source: managedSecret, secretName } o source: workerEnvironment. Ver platform/harnesses/authentication.",
  },
  {
