...
describe("infra.derive — WarpFactories.md §13/§14 + §8 Runners + E15 US-131→139, E07 US-064→066", () => {
  ...
  describe("4 credential boundaries §13", () => {
    ...
    it("Harness mentions harness.auth sources", () => {
      expect(CREDENTIAL_BOUNDARIES[2].boundary).toMatch(/managedSecret/);
      expect(CREDENTIAL_BOUNDARIES[2].boundary).toMatch(/workerEnvironment/);
    });
