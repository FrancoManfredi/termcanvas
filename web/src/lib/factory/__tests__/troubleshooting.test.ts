  ...
  describe("HelpSection — SOLID: page lista, section muestra, DIP no necesita store", () => {
    it("renders title and description and children", () => {
      const { container } = render(
        React.createElement(HelpSection, { id: "test-section", title: "Test Title", description: "Desc", children: "Child content" })
      );
    ...
    it("renders without description", () => {
      render(React.createElement(HelpSection, { id: "no-desc", title: "Only Title", children: "Body" }));
