              ...
              <table className="w-full text-left text-[12px]">
                ...
                <tbody className="divide-y divide-zinc-200 bg-white">
                  ...
                  <tr>
                    ...
                    <td className="px-3 py-2 text-zinc-600">Third-party harnesses (Claude Code, Codex)</td>
                    <td className="px-3 py-2 text-zinc-600">
                      Config separada de secrets. Dashboard: Auth; definitions: harness.auth {"{source: managedSecret|workerEnvironment}"}
                    </td>
                  </tr>
                  <tr>
