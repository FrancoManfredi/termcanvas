      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="mx-auto max-w-[1080px] space-y-4">
          <section className="rounded-[12px] border border-zinc-200 bg-white p-4">
            ...
            <div className="mt-2 rounded-[8px] border border-violet-200 bg-violet-50 px-3 py-2">
              <p className="text-[11px] font-medium text-violet-800">no winner — Warp no elige ganador; Correctness built-in vs success criteria + credit no model</p>
              <p className="mt-1 text-[11px] text-violet-700">Repetitions: {definition.repetitions} por task+config · pass rates/cost/quality per config · human pondera cost vs quality</p>
            </div>
          </section>
