export const en = {
  ...
  planner_toolbar_label: "Plan issues",
  repo_context_toolbar_label: "Repository context",
  repo_context_title: "Repository context",
  repo_context_hint:
    "Free-form Markdown injected into every planning session. Use it to describe the project's purpose, vision, rules, and intentions — anything that should weigh on every proposal.",
  repo_context_saved: "Repository context saved.",
  repo_context_save_error: "Could not save repository context.",
  repo_context_no_project: "Open a project first to edit its context.",
  repo_context_placeholder:
    "# Repository context\n\nWhat is this project about? What rules should every proposal respect?",
  repo_context_save: "Save",
  ...
  phase_models_title: "Models per phase",
  phase_models_desc:
    "Pin a provider/model for each AI workflow phase. Without an override, each phase uses its default (or the CLI's global default).",
  phase_models_load_failed: "Could not load available models.",
  phase_models_refresh: "Refresh catalog",
  phase_model_default: "Default",
  phase_model_available: "Available",
  phase_model_missing: "Not available",
  phase_model_checking: "Checking…",
  phase_model_search_placeholder: "Search provider/model…",
  phase_model_models_suffix: "models — type to filter",
  phase_model_more: (count: number) => `…and ${count} more — refine your search`,
  phase_model_no_results: "No results.",
  phase_model_no_auth: "no auth",
  phase_cli_tui_label: "Run CLI phases in interactive TUI",
  phase_cli_tui_desc:
    "Off = headless `opencode run` with guaranteed model pin. On = interactive TUI; the pin there depends on the CLI honoring --model (currently unreliable).",
  phase_cli_mode_headless: "Headless (recommended)",
  phase_cli_mode_tui: "Interactive TUI",
  ai_activity_title: "AI ACTIVITY",
  ai_activity_empty: "No model calls yet in this phase.",
  phase_brief: "Business brief (interview + synthesis)",
  phase_requirements: "Requirements interview",
