export const zh = {
  ...
  planner_toolbar_label: "规划议题",
  repo_context_toolbar_label: "仓库上下文",
  repo_context_title: "仓库上下文",
  repo_context_hint:
    "自由格式的 Markdown，会注入到每次规划会话中。用它描述项目的目标、愿景、规则和意图——任何应影响每项提案的内容。",
  repo_context_saved: "仓库上下文已保存。",
  repo_context_save_error: "无法保存仓库上下文。",
  repo_context_no_project: "请先打开一个项目再编辑其上下文。",
  repo_context_placeholder:
    "# 仓库上下文\n\n这个项目是做什么的？每项提案应遵循哪些规则？",
  repo_context_save: "保存",
  ...
  settings_skills: "分类 Skills",
  settings_skills_desc: "按诊断类别管理第三方 Skills，诊断时临时使用。",
  ...
  phase_models_title: "按阶段的模型",
  phase_models_desc:
    "为每个 AI 工作流阶段指定提供商/模型。未指定时使用各阶段的默认值（或 CLI 的全局默认）。",
  phase_models_load_failed: "无法加载可用模型。",
  phase_models_refresh: "刷新目录",
  phase_model_default: "默认",
  phase_model_available: "可用",
  phase_model_missing: "不可用",
  phase_model_checking: "检查中…",
  phase_model_search_placeholder: "搜索提供商/模型…",
  phase_model_models_suffix: "个模型 — 输入以筛选",
  phase_model_more: (count: number) => `…还有 ${count} 个 — 请细化搜索`,
  phase_model_no_results: "无结果。",
  phase_model_no_auth: "未认证",
  phase_cli_tui_label: "以交互式 TUI 运行 CLI 阶段",
  phase_cli_tui_desc:
    "关闭 = 无头 `opencode run`，模型指定可靠。开启 = 交互式 TUI；该模式下模型指定依赖 CLI 是否遵守 --model（目前不可靠）。",
  phase_cli_mode_headless: "无头（推荐）",
  phase_cli_mode_tui: "交互式 TUI",
  ai_activity_title: "AI 活动",
  ai_activity_empty: "此阶段尚未调用模型。",
  phase_brief: "业务简报（访谈 + 综合）",
  phase_requirements: "需求访谈",
