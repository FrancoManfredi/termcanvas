// WarpPanel icon set — ported verbatim from
// figma/Crear panel lateral interactivo/src/components/icons.tsx
// (file renamed to warpIcons.tsx to avoid collisions with host icon sets).
