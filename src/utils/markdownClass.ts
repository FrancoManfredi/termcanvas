...
export const markdownClassName =
  ...
  "[&_h1]:text-[17px] [&_h1]:font-semibold [&_h1]:mt-3 [&_h1]:mb-1.5 " +
  "[&_h2]:text-[16px] [&_h2]:font-semibold [&_h2]:mt-3 [&_h2]:mb-1 " +
  "[&_h3]:text-[15px] [&_h3]:font-semibold [&_h3]:mt-2 [&_h3]:mb-1 " +
  "[&_h4]:text-[length:var(--text-md)] [&_h4]:font-semibold [&_h4]:mt-2 [&_h4]:mb-1 " +
  ...
  "[&_p]:break-words [&_li]:break-words [&_h1]:break-words [&_h2]:break-words [&_h3]:break-words [&_h4]:break-words [&_a]:break-all " +
